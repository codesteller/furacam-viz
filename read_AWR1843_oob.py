...
# configFileName = 'configs/radar/AWR1843config.cfg'
configFileName = "configs/radar/test_1843.cfg"
...
def readAndParseData18xx(Dataport, configParameters):
    ...
    if debugFlag:
        print("[INFO] Read Buffer Length: {}".format(len(readBuffer)))
        print("[INFO] Read Buffer: {}".format(readBuffer))
    ...
    if debugFlag:
        print("[INFO] Byte Buffer Length: {}".format(byteBufferLength))
        print("[INFO] Byte Buffer: {}".format(byteBuffer))
    ...
    if byteBufferLength > 16:
        ...
        if startIdx:
            ...
            if (byteBufferLength >= totalPacketLen) and (byteBufferLength != 0):
                magicOK = 1
    if debugFlag:
        print("[INFO] MagicOK: {}".format(magicOK))
